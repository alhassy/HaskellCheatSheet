...
# Using these laws, we can define a lawful definition of ~fmap~
# but lawful ~fmap~'s
...
| [[https://hackage.haskell.org/package/base-4.12.0.0/docs/Control-Applicative.html#t:Const][Constant]]    | ~ε~            | ~λ x → x~  ---Shucks! Not a monad!        |
